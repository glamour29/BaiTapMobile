...
class MainActivity : AppCompatActivity() {
    ...
    private fun hienThiDanhSachTen() {
        AlertDialog.Builder(this)
            ...
            .setItems(danhSachTen) { _, which ->
                binding.edtTenNV.setText(danhSachTen[which]) // Sử dụng binding thay vì findViewById()
    ...
    // Kiểm tra nếu tất cả các checkbox trong danh sách đều đã chọn
    ...
    private fun themSachMoi() {
        ...
        val newCheckBox = CheckBox(this).apply {
            ...
            // Thiết lập LayoutParams để kích thước giống như các CheckBox đã có trong XML
            val layoutParams = LinearLayout.LayoutParams(
                convertDpToPx(300f), // Chiều rộng 300dp
                convertDpToPx(50f)   // Chiều cao 50dp
            ).apply {
                setMargins(
                    convertDpToPx(20f), // Margin trái và phải
                    convertDpToPx(10f), // Margin trên và dưới
                    convertDpToPx(20f), // Margin trái và phải
                    convertDpToPx(10f)  // Margin dưới
                )
            }
